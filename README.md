...
- ``apps\mfe1\webpack.config.js``: Microfrontend config
- ``apps\shell\webpack.config.js``: Shell config
- ``apps\shell\src\app\app.routes.ts``: Lazy route for microfrontend
- ``apps\shell\src\decl.d.ts``: Typing for mapped Url pointing to microfrontend
